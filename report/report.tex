...
Wikipedia's quality has been extensively studied since its inception. \citet{giles2005internet} found Wikipedia's accuracy comparable to Encyclopedia Britannica in scientific articles, though with higher error rates. \citet{wohner2009assessing} demonstrated significant quality variance across Wikipedia articles, with established topics receiving more editorial attention. More recent work by \citet{mesgari2015sum} synthesized Wikipedia quality research, identifying content accuracy, completeness, and currency as key evaluation dimensions.
...
Articles were retrieved from both platforms during October-November 2025. Full article texts, citation counts, and metadata were recorded. For Wikipedia, we noted the last revision date; for Grokipedia (version 0.1, accessed 1 November 2025 with 885,279 articles available), the fact-checking timestamp. This temporal information proved crucial for timeliness assessment.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{images/overall-comparison.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{images/topics-comparison.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{images/dimension-comparison.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{images/key-findings.pdf}
